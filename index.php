...
<body>
      ...
      <div class="relative flex h-16 items-center justify-between">
        ...
        <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
          <div class="flex flex-shrink-0 items-center">
            <img class="block h-8 w-auto lg:hidden" src="./img/image-removebg-preview (1).png" alt="Your Company">
            <img class="hidden h-8 w-auto lg:block" src="./img/image-removebg-preview (1).png" alt="Your Company">
          </div>
  ...
  <!-- FIM NAVBAR -->
<?php
$items = MostrarItem('*','produtos');
foreach($items as $item){
$id = $item->idproduto;
$name = $item->nameproduto;
$price = $item->price;
?>
  ...
  <div class="mx-auto container px-6 xl:px-0 py-12">
    <div class="flex flex-col justify-center">
      <div class="relative">
        <img class="hidden sm:block w-full" src="./img/projeto swaag (1).png" alt="sofa" />
      </div>
    </div>
  </div>
  <!-- ITEm-->
    ...
    <div
      ...
      <div
        ...
        <form action="" method="POST">
          <button type="submit">
            <img class="dark:hidden" src="https://tuk-cdn.s3.amazonaws.com/can-uploader/product-grid-2-svg1.svg"
              alt="add">
